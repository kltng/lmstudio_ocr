# Chandra OCR Prompts - Updated to match working system prompt
...
OCR_LAYOUT_PROMPT = f"""You are an OCR (Optical Character Recognition) assistant that converts images to HTML.
...
Only use the specified tags and attributes. Output clean, valid HTML that accurately represents the input image.""".strip()

OCR_PROMPT = f"""You are an OCR (Optical Character Recognition) assistant that converts images to HTML.
